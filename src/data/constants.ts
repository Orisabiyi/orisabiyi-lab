export const SITE = {
  ...
  about: [
    ...
    "I\u2019m dedicated to crafting beautiful and highly functional products that seamlessly align with my clients\u2019 unique needs and long-term goals.",
  ],
  aboutLong: [
  ...
  social: {
    ...
    twitter: "https://twitter.com/orisabiyi",
